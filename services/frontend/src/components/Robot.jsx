...
export default function Robot() {
  ...
  const [emotion, setEmotion] = useState("stand-by");
  ...
  const pageClass = `page bot-${started ? emotion : "stand-by"}`;
      ...
      >
        <div className="action">
          <svg
            ...
            y="0px"
            viewBox="0 0 590 140"
            style={{ enableBackground: "new 0 0 590 140" }}
            xmlSpace="preserve"
          >
            <g>
              <path
        ...
        <div className="bot">
          <div className="bot-head">
            <div className="bot-face">
              <i className="eye eye-left"></i>
              <i className="eye eye-right"></i>
            ...
            <svg
              ...
              y="0px"
              viewBox="0 0 219 157"
              style={{ enableBackground: "new 0 0 219 157" }}
              xmlSpace="preserve"
            >
              <g>
                <path
          ...
          <div className="bot-body">
            <div className="bot-body-active">
              <svg
                ...
                y="0px"
                viewBox="0 0 226 175"
                style={{ enableBackground: "new 0 0 226 175" }}
                xmlSpace="preserve"
              >
                <path
                  className="st0"
          ...
          <div className="levitas">
            <i className="levitas-first"></i>
            <i className="levitas-second"></i>
            <i className="levitas-third"></i>
            <i className="levitas-four"></i>
          </div>
